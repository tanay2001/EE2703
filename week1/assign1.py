...
def getTokens(line):
    ...
    if l==4 or (l>4 and tokens[4][0] =='#'):
        ...
        print('{} of value {} , connected from {} to {} and is  dependent on controlled source across {} and {}'.format(element, value,n2,n1,n4,n3))
        ...
        print('{} of value {} , connected from {} to {} and is  dependent on current through voltgae source {}'.format(element, value,n2,n1,V))
